...
export const CURATED_STREETS: CuratedStreet[] = [
  // --- MA1: Norte da Av. Moab Caldas (lado esquerdo/oeste subindo) ---
  ...
  { nome: 'Rua Januário Scalzilli', lat: -30.0718656, lng: -51.2160464, microarea: 'MA1' },
  { nome: 'Rua Felipe Weimann', lat: -30.0735963, lng: -51.2171576, microarea: 'MA1' },

  // --- MA2: Área central — entre Moab Caldas e Beco dos Coqueiros ---
  ...
  { nome: 'Rua Banco Inglês', lat: -30.0722844, lng: -51.2209007, microarea: 'MA2' },
  { nome: 'Beco dos Coqueiros', lat: -30.0731362, lng: -51.2215084, microarea: 'MA2' },
  ...
  // --- MA3: Lado oeste (Becos e acessos) ---
  ...
  // --- MA4: Sul — Vila Cruzeiro (próximo à Cruzeiro do Sul) ---
  { nome: 'Rua Cruzeiro do Sul', lat: -30.0769872, lng: -51.2238590, microarea: 'MA4' },
  { nome: 'Rua Flores', lat: -30.0752843, lng: -51.2245407, microarea: 'MA4' },
  ...
  // --- MA5: Leste — próximo à Coronel Aparício Borges ---
  { nome: 'Rua Antônio Pereira Júnior', lat: -30.0750849, lng: -51.2201410, microarea: 'MA5' },
  { nome: 'Rua Gibran Khalil Gibran', lat: -30.0770083, lng: -51.2204013, microarea: 'MA5' },
  { nome: 'Rua Doutor Leônidas Soares Machado', lat: -30.0760913, lng: -51.2182121, microarea: 'MA5' },
  { nome: 'Rua Paulino Vasco Micco', lat: -30.0768681, lng: -51.2179651, microarea: 'MA5' },
